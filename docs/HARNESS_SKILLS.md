...
| Proposal | `ticket-proposal-plan` with `goal=proposal` | Analysis complete | `proposal.md` | Missing analysis, unresolved ambiguity, or attempt to create plan or code before proposal approval |
